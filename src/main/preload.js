...
contextBridge.exposeInMainWorld('openslides', {
  ...
  genSoloOutline: (text, settings, workspaceFiles) => ipcRenderer.invoke('llm:solo-outline', { text, settings, workspaceFiles }),
  genSoloSlide: (params, settings, workspaceFiles) => ipcRenderer.invoke('llm:solo-slide', { ...params, settings, workspaceFiles }),
  ...
  pickWorkspaceFiles: () => ipcRenderer.invoke('workspace:pick-files'),
