...
const STRINGS = {
  en: {
    ...
    petSection:          'Desktop Pet',
    petSpritesheetUrl:   'Spritesheet URL',
    petSpritesheetHint:  'Paste a Petdex spritesheet URL (8×9 grid). Leave empty to disable.',
    petGalleryLoading:   'Loading Petdex gallery…',
    petGalleryError:     'Failed to load gallery',
    petGallerySearch:    'Search pets…',
    petGalleryActive:    'Active pet',
    petGalleryRemove:    'Remove',
    petGalleryUse:       'Use this pet',
    petGalleryCancel:    'Cancel',
    petGalleryAlready:   'Active',
    petGalleryPrev:      '← Prev',
    petGalleryNext:      'Next →',
  ...
  zh: {
    ...
    petSection:          '桌宠',
    petSpritesheetUrl:   '精灵图 URL',
    petSpritesheetHint:  '粘贴 Petdex 精灵图 URL（8×9 格式）。留空则关闭桌宠。',
    petGalleryLoading:   '正在加载 Petdex 图鉴…',
    petGalleryError:     '加载失败',
    petGallerySearch:    '搜索精灵…',
    petGalleryActive:    '当前桌宠',
    petGalleryRemove:    '移除',
    petGalleryUse:       '使用此精灵',
    petGalleryCancel:    '取消',
    petGalleryAlready:   '已激活',
    petGalleryPrev:      '← 上一页',
    petGalleryNext:      '下一页 →',
